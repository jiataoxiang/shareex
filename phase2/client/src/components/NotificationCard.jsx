...
class NotificationCard extends React.Component {
  ...
  deleteMsg = () => {
    axios
      .delete(`/api/notifications/${this.state._noti_id}`, this.tokenConfig())
      .then(result => {
      ...
      <div className="notification-card row border rounded">
        ...
        <div className="contant-container col">
          ...
          <span className="msg-status">
            <span className="msg-time">{this.state.time}</span>
            {this.state.link ? (
              <Link className="msg-link" to={this.state.link}>
                <button id="detail-btn" className="detail-btn btn btn-outline-primary">
                  Detail
                </button>
              </Link>
            ) : null}
            {this.state.deleted ? (
              ...
              <button className="delete-btn btn btn-danger" onClick={this.deleteMsg}>
                Delete
              </button>
            )}
          </span>
